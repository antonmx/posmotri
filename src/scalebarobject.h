...
public :
  ...
  static ScaleBarObject interpolate(ScaleBarObject&, ScaleBarObject&, float);
  static QList<ScaleBarObject> interpolate(QList<ScaleBarObject>, QList<ScaleBarObject>,  float);
